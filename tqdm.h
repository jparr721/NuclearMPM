...
namespace tqdm {
   ...
   */
        ...
        explicit Tqdm(_Iterator begin, size_t total) : TQDM_IT(begin), e(begin + total), self() { self.total = total; }
        ...
        virtual void _incr() const override {
            if (this->get() == e) throw std::out_of_range("exhausted");// TODO: don't throw, just double total
    ...
    template<typename _Container, typename _Tqdm = Tqdm<typename _Container::iterator>>
